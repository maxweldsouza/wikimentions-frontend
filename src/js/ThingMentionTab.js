...
const ThingMentionTab = ({ mentions, type, id, count, path, loggedin, page = '1' }) => {
    ...
    let addmention;
    if (type === 'person') {
        addmention = <AddMention id={id} type={type} mentioned_by={id} loggedin={loggedin}/>;
    } else {
        addmention = <AddMention id={id} type={type} mentioned_in={id} loggedin={loggedin}/>;
    }
