                    ...
                    <div className="small-12 large-8 columns">
                        <div className="row">
                            <div className="small-12 columns">
                                <h1>
                                    {this.props.data.thing.props.title} - Quotes
                                </h1>
                                <PageBar
                                    ...
                                    ? <div className="row">
                                          <div className="shrink columns">
                                              <Thumbnail
                                                  ...
                                                  type={
                                                      this.props.data.thing.props.type
                                                  }
                                                  image={
                                                      this.props.data.thing.image
                                                  }
                                                  url={
                                                      this.props.data.thing.props.url
                                                  }
                                                  displayWidth={75}
                                              />
                                          </div>
