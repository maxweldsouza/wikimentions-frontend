            ...
            results = (
                <div>
                    {data.map(x => {
                        return (
                            <div>
                                <Link type="book" id={x.id} slug={x.props.slug}>
                                    {x.props.title}
                                </Link>
                            </div>
                        );
