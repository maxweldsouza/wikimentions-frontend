        ...
        if (this.props.entry && this.props.entrytype === 'video_author') {
            ...
            item = (
                <span className="row">
                    ...
                    {this.props.entry.mentioned_in
                        ? <span className="small-12 columns">
                              Mentioned In: <Link
                                  id={this.props.entry.mentioned_in.id}
                                  slug={
                                      this.props.entry.mentioned_in.props.slug
                                  }
                                  type={
                                      this.props.entry.mentioned_in.props.type
                                  }
                              >
            ...
            item = (
                <span className="row">
                    ...
                    <span className="columns">
                        ...
                        {' '}
                        <Markdown markdown={this.props.entry.description} />
                    </span>
                </span>
            );
            ...
            item = (
                <span className="row">
                    <span className="small-12 columns">
                        List: <a
                            href={
                                `/lists/${this.props.entry.id}/${this.props.entry.slug}`
                            }
                        >
                            {this.props.entry.title}
                        </a>
                ...
                <span className="row">
                    <span className="small-12 columns">
                        ...
                        <div>
                            List: <a
                                href={
                                    `/lists/${this.props.entry.list.id}/${this.props.entry.list.slug}`
                                }
                            >
            ...
            <div className="small-12 columns">
                <div className="row">
                    <span className="small-8 columns">
                        <strong style={{ fontSize: 17 }}>{type}</strong>
                        {' '}
                        {added}
                        {' '}
                        <strong>
                            {this.props.username
                                ? <a
                                      ...
                                      rel="nofollow"
                                      href={
                                          `/users/${this.props.user}/${this.props.username}`
                                      }
                                  >
                                      {this.props.username}
                                  </a>
                    ...
                    <span className="small-4 columns text-right">
                        <Time
